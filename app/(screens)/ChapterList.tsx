...
//   const [allChapters, setAllChapters] = useState<chapterList[]>([]);
  
//   const [loading, setLoading] = useState(true);

//   useEffect(() => {
//     const fetchChaptersData = async () => { // Made async unnecessary as it's just a setTimeout
...
//             id: item.id,
//             title: item.name,
//             lessonNumber: item.chap_num,
//           }))
//           .sort((a, b) => a.lessonNumber - b.lessonNumber);

//           const allChapeterFromDB:chapterList[] = data.map((item:any)=>(
//             id:item.id,
