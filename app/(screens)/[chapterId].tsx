...
//   // 'language' here comes from params (e.g., "en-IN", "kn-IN")
//   const { title = "Chapter", lessonNumber = "?", textUrl = "", language = "en-IN" } = useLocalSearchParams() as any;

//   // --- LANGUAGE LOGIC ---
//   // 1. For Speech: Use full locale (e.g., 'en-IN', 'kn-IN')
//   const speechLanguage = language;
  
//   // 2. For Games/Backend: Extract the base code (e.g., 'en', 'kn')
//   // This splits "en-IN" to get "en", "kn-IN" to get "kn"
//   const simpleLanguage = language.includes('-') ? language.split('-')[0] : language;

//   console.log("BACKEND LANGUAGE=",simpleLanguage)
...
//       const payload = {
//         language: simpleLanguage, // Use simple code (en, kn) for backend
...
//       language: speechLanguage, // Use full locale (en-IN) for TTS
//       rate: 0.8,
//       pitch: 1.0,
...
//       // For dictionary, default to English definitions regardless of lesson language
//       // or map 'kn' -> 'en' if dictionary only supports English.
//       // Currently using 'en' as hardcoded in your original snippet for dictionary lookup.
...
//   // ... (ClickableText, ReadBlockBtn, renderBlocks helper functions remain unchanged)
...
//         language={simpleLanguage} // Pass the simple code (en, kn, hi) here
//       />
//     </AnimatedBackground>
//   );
// }
